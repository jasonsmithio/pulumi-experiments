# CREATING AN AI TRAINING PLATFORM ON GKE WITH PULUMI


We are using [this tutorial from Google Cloud](https://cloud.google.com/kubernetes-engine/docs/quickstarts/train-model-gpus-standard).
